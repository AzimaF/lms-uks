const a=[{id:1,title:"Chapter 1: Mengenal Kuman TBC",description:"Memahami definisi, penyebab, patogenesis, dan gejala klinis Tuberkulosis sesuai standar Kemenkes RI.",modules:[{id:"1-1",title:"Definisi & Penyebab TBC",videoUrl:"https://www.youtube.com/embed/zFQLKLhnFPg?si=zVzqCkDmYnp6Q_r_",content:`
        ...
        `},{id:"1-2",title:"Cara Penularan & Patogenesis",videoUrl:"",content:`
        ...
        `},{id:"1-3",title:"Gejala Klinis pada Anak & Remaja",videoUrl:"",content:`
        ...
        `},{id:"1-4",title:"Kelompok Risiko Tinggi",videoUrl:"",content:`
        ...
        `}],quiz:[{question:"Apa penyebab utama penyakit Tuberkulosis (TBC)?",options:["Faktor keturunan/genetik","Bakteri Mycobacterium tuberculosis","Guna-guna atau santet","Keracunan makanan basi"],correct:1},{question:"Bagaimana cara penularan kuman TBC yang paling utama?",options:["Melalui tukar menukar alat makan","Melalui gigitan nyamuk","Melalui udara (percikan dahak/droplet)","Melalui sentuhan kulit"],correct:2},{question:"Manakah yang BUKAN merupakan gejala umum TBC pada anak?",options:["Batuk lama lebih dari 2 minggu","Demam tinggi mendadak seperti demam berdarah","Berat badan turun atau tidak naik","Anak tampak lesu dan kurang aktif"],correct:1},{question:"Kelompok mana yang paling berisiko mengalami sakit TBC berat?",options:["Anak usia sekolah (SD)","Remaja atletis","Balita (< 5 tahun) dan anak dengan gizi buruk","Orang dewasa sehat"],correct:2}]},{id:2,title:"Chapter 2: Pencegahan & Pengendalian TBC",description:"Strategi pencegahan TBC: TPT, Vaksinasi, dan Pengendalian Infeksi.",modules:[{id:"2-1",title:"Pencegahan dengan TPT & Vaksinasi",videoUrl:"",content:`
        ...
        `},{id:"2-2",title:"Pengendalian Lingkungan & Ventilasi",videoUrl:"",content:`
        ...
        `},{id:"2-3",title:"Etika Batuk & Higiene Respirasi",videoUrl:"https://www.youtube.com/embed/pKr2R7_I9w8?si=0ALkXy8k4fcGPLZj",content:`
        ...
        `},{id:"2-4",title:"Strategi Pengobatan: TOSS TBC",videoUrl:"",content:`
        ...
        `}],quiz:[{question:"Apa kepanjangan dari slogan TOSS TBC?",options:["Tolong Orang Sakit Segera","Temukan Obat Sampai Sembuh","Tidak Obat Susah Sembuh","Tetap Optimis Selalu Sehat"],correct:1},{question:"Mengapa ventilasi udara (jendela terbuka) penting untuk pencegahan TBC?",options:["Agar ruangan menjadi dingin","Untuk mengurangi konsentrasi kuman di udara & masuk sinar matahari","Agar debu bisa masuk","Supaya hemat listrik"],correct:1},{question:"Manakah cara etika batuk yang BENAR?",options:["Menutup mulut dengan telapak tangan","Batuk diarahkan ke teman","Menutup mulut dengan lengan atas bagian dalam atau tisu","Tidak perlu menutup mulut"],correct:2},{question:"Apa tujuan utama pemberian TPT (Terapi Pencegahan TBC)?",options:["Menyembuhkan TBC aktif","Mencegah infeksi laten berkembang menjadi sakit TBC aktif","Menggantikan vaksin BCG","Mengobati batuk pilek biasa"],correct:1}]},{id:3,title:"Chapter 3: Ringkasan & Evaluasi Akhir",description:"Ujian komprehensif untuk menguji pemahaman seluruh materi TBC.",modules:[{id:"3-1",title:"Rangkuman Materi TBC",videoUrl:"",content:`
        ...
        `}],quiz:[{question:"Apa nama bakteri penyebab penyakit Tuberkulosis?",options:["Escherichia coli","Mycobacterium tuberculosis","Salmonella typhi","Streptococcus pneumoniae"],correct:1},{question:"Bagaimana cara penularan utama kuman TBC?",options:["Melalui makanan basi","Melalui gigitan serangga","Melalui percikan dahak di udara (droplet)","Melalui sentuhan kulit"],correct:2},{question:"Manakah mitos yang SALAH tentang TBC?",options:["TBC disebabkan oleh bakteri","TBC bisa disembuhkan","TBC adalah penyakit keturunan/kutukan","TBC menular lewat udara"],correct:2},{question:"Apakah TBC bisa menular lewat piring atau gelas bekas pasien?",options:["Ya, sangat menular","Tidak menular lewat alat makan","Mungkin saja","Hanya jika tidak dicuci"],correct:1},{question:"Berapa lama durasi batuk yang dicurigai sebagai gejala TBC?",options:["1-2 hari","Kurang dari 1 minggu","Lebih dari 2 minggu","Hanya saat malam hari"],correct:2},{question:"Apa gejala khas TBC pada anak yang sering terlewatkan?",options:["Batuk berdarah hebat","Berat badan tidak naik atau turun drastis (Gagal Tumbuh)","Sakit kepala migrain","Gatal-gatal di seluruh tubuh"],correct:1},{question:"Gejala 'keringat malam' pada pasien TBC terjadi saat...",options:["Berolahraga berat di malam hari","Tidur malam tanpa melakukan aktivitas fisik","Memakai selimut tebal","Cuaca sedang panas"],correct:1},{question:"Batuk berdarah (hemoptisis) lebih sering ditemukan pada kelompok usia mana?",options:["Bayi baru lahir","Balita","Remaja dan Dewasa","Semua umur sama"],correct:2},{question:"Siapa kelompok anak yang paling berisiko tertular TBC berat?",options:["Anak usia sekolah (SD)","Anak balita (< 5 tahun) dan imunokompromais","Remaja atletis","Bayi yang sudah divaksin lengkap"],correct:1},{question:"Penyakit penyerta apa yang memperparah risiko sakit TBC?",options:["HIV/AIDS dan Diabetes Melitus","Panu dan Kurap","Sakit gigi berlubang","Maag dan Asam Lambung"],correct:0},{question:"Vaksin apa yang diberikan untuk mencegah TBC berat pada bayi?",options:["Vaksin Polio","Vaksin Hepatitis B","Vaksin BCG","Vaksin Campak"],correct:2},{question:"Kapan waktu ideal pemberian vaksin BCG?",options:["Usia 0-1 bulan (segera setelah lahir)","Saat masuk sekolah TK","Saat usia 17 tahun","Saat sudah sakit TBC"],correct:0},{question:"Apa tujuan pemberian Terapi Pencegahan TBC (TPT)?",options:["Mengobati pasien yang sudah sakit parah","Mencegah orang sehat yang terinfeksi agar tidak jatuh sakit","Menggantikan fungsi makanan","Menyembuhkan batuk pilek biasa"],correct:1},{question:"Mengapa membuka jendela rumah/kelas itu penting?",options:["Supaya bisa melihat pemandangan","Agar sirkulasi udara lancar dan sinar matahari masuk membunuh kuman","Supaya debu jalanan masuk","Agar ruangan menjadi dingin"],correct:1},{question:"Bagaimana cara menutup mulut saat batuk yang BENAR?",options:["Menggunakan telapak tangan kosong","Tidak perlu ditutup","Menggunakan lengan atas bagian dalam atau tisu","Menggunakan kerah baju teman"],correct:2},{question:"Apa kepanjangan dari slogan TOSS TBC?",options:["Tolong Orang Sakit Segera","Temukan Obat Sampai Sembuh","Tidak Obat Susah Sembuh","Tetap Optimis Selalu Sehat"],correct:1},{question:"Berapa lama minimal pengobatan TBC harus dijalani?",options:["3 hari","1 minggu","1 bulan","6 bulan"],correct:3},{question:"Apa akibatnya jika pasien berhenti minum obat TBC sebelum waktunya?",options:["Langsung sembuh total","Kuman menjadi kebal obat (Resistensi) dan lebih susah diobati","Tidak ada akibat apa-apa","Pasien menjadi lebih sehat"],correct:1},{question:"Apa yang harus dilakukan jika ada anggota keluarga serumah yang sakit TBC?",options:["Mengucilkan dan memisahkan alat makannya selamanya","Mendukung pengobatannya dan membawa seluruh kontak serumah untuk diperiksa","Menyembunyikan penyakitnya dari tetangga","Membelikan obat batuk warung saja"],correct:1},{question:"Apakah TBC bisa disembuhkan?",options:["Tidak bisa, penyakit seumur hidup","Bisa, dengan pengobatan rutin dan tuntas","Bisa sembuh sendiri tanpa obat","Hanya bisa diredakan gejalanya"],correct:1}]}];export{a as c};
