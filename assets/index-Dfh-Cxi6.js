...
(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))r(n);new MutationObserver(n=>{for(const i of n)if(i.type==="childList")for(const o of i.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&r(o)}).observe(document,{childList:!0,subtree:!0});function a(n){const i={};return n.integrity&&(i.integrity=n.integrity),n.referrerPolicy&&(i.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?i.credentials="include":n.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function r(n){if(n.ep)return;n.ep=!0;const i=a(n);fetch(n.href,i)}})();const S="modulepreload",C=function(t){return"/lms-uks/"+t},f={},c=function(e,a,r){let n=Promise.resolve();if(a&&a.length>0){document.getElementsByTagName("link");const o=document.querySelector("meta[property=csp-nonce]"),s=(o==null?void 0:o.nonce)||(o==null?void 0:o.getAttribute("nonce"));n=Promise.allSettled(a.map(l=>{if(l=C(l),l in f)return;f[l]=!0;const d=l.endsWith(".css"),x=d?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${l}"]${x}`))return;const u=document.createElement("link");if(u.rel=d?"stylesheet":S,d||(u.as="script"),u.crossOrigin="",u.href=l,s&&u.setAttribute("nonce",s),document.head.appendChild(u),d)return new Promise((y,w)=>{u.addEventListener("load",y),u.addEventListener("error",()=>w(new Error(`Unable to preload CSS for ${l}`)))})}))}function i(o){const s=new Event("vite:preloadError",{cancelable:!0});if(s.payload=o,window.dispatchEvent(s),!s.defaultPrevented)throw o}return n.then(o=>{for(const s of o||[])s.status==="rejected"&&i(s.reason);return e().catch(i)})},_="/lms-uks/uks-home.png";class M{constructor(){this.navbarContainer=document.getElementById("navbar"),this.footerContainer=document.getElementById("footer"),this.container=document.querySelector("main")}renderNavbar(e){this.navbarContainer&&(this.navbarContainer.innerHTML="",this.navbarContainer.appendChild(e))}renderFooter(e){this.footerContainer&&(this.footerContainer.innerHTML="",this.footerContainer.appendChild(e))}renderContent(){const e=localStorage.getItem("tbcCourseCompleted")==="true";let a,r;if(e)a='<a href="/diagnosis" data-link class="btn-primary text-center px-8 shadow-lg">Mulai Cek Gejala</a>',r='<a href="/diagnosis" data-link class="btn-primary text-lg px-10 py-3 shadow-xl">Mulai Diagnosis Sekarang</a>';else{const i=`
            Swal.fire({
        ...
        <div class="card mb-12 bg-gradient-to-br from-white to-[color:var(--color-lightblue)]">
          <div class="flex flex-col md:flex-row items-center gap-12">
            ...
            <div class="flex-1 flex flex-col items-center justify-center relative">
              <img src="${_}" alt="Logo UKS Muhammadiyah 36" class="h-64 w-64 object-contain transform hover:scale-105 transition-transform duration-300 mb-10" />
    ...
    `}bindStartCheckup(e){const a=document.querySelector('a[data-link][href="/diagnosis"]');a&&a.addEventListener("click",e)}bindLearnMore(){const e=document.querySelector('a[data-link][href="/#features"]');e&&e.addEventListener("click",a=>{a.preventDefault();const r=document.querySelector("#features");r&&r.scrollIntoView({behavior:"smooth"})})}}const g="/lms-uks/uks-icon.png";class j{constructor(){this.container=document.querySelector("main")}renderContent(){this.container.innerHTML=`
        ...
        <div class="flex flex-col items-center justify-center min-h-[80vh] bg-[color:var(--color-lightergray)] px-2 py-8">
          <div class="max-w-3xl w-full mx-auto">
            <div class="bg-white rounded-3xl shadow-2xl p-10 flex flex-col items-center gap-8 border border-[color:var(--color-border)] relative overflow-hidden" style="animation: fadeInUp 0.6s ease-out both;">
              ...
              <img src="${g}" alt="Logo UKS Muhammadiyah 36" class="h-24 w-24 mb-2 drop-shadow-md transform hover:scale-110 transition-transform duration-500" />
  ...
  `,t}const P=Object.freeze(Object.defineProperty({__proto__:null,createFooter:k},Symbol.toStringTag,{value:"Module"}));function E(){window.addEventListener("DOMContentLoaded",()=>{document.getElementById("navbar").appendChild(b()),document.getElementById("footer").appendChild(k());const t=location.hash.replace("#","")||"/";h(t).then(()=>{p()}),document.body.addEventListener("click",e=>{const a=e.target.closest("a[data-link]");if(a){e.preventDefault();let n=new URL(a.href).pathname.replace("/lms-uks","");n===""&&(n="/"),history.pushState(null,"","#"+n),h(n).then(()=>{window.scrollTo({top:0,behavior:"smooth"}),p()})}}),window.addEventListener("hashchange",()=>{const e=location.hash.replace("#","")||"/";h(e).then(()=>{p()})})})}E();export{j as A,c as _,P as f,L as n,g as u};
