...
export default class QuizView {
  ...
  handleAnswer(selectedIndex) {
    ...
    this.userAnswers.push({
        ...
        questionText: this.data.quiz[this.currentQuestion].question, 
        selected: selectedIndex,
        selectedText: this.data.quiz[this.currentQuestion].options[selectedIndex], 
        correct: correctIndex,
        correctText: this.data.quiz[this.currentQuestion].options[correctIndex] 
    });
  ...
  finishQuiz() {
    ...
    const historyItem = {
        ...
        // --- [PERBAIKAN PENTING] ---
        // Simpan Snapshot soal yang sudah diacak agar halaman detail bisa membacanya
        quizSnapshot: this.data.quiz 
        // ---------------------------
    };
